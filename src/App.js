      ...
      <div className='todo-wrapper'>
        <div className='todo-input'>
          ...
          <div className='todo-input-item'>
            ...
            <input type="text" value={newDescription} onChange={(e)=>setNewDescription(e.target.value)} placeholder="What is the task discription?" />
          </div>
          <div className='todo-input-item'>
            ...
            return(
              <div className="todo-list-item" key={index}>
                ...
                <div>
                 ...
                 <IoCheckmarkDoneSharp className='react-icon' 
